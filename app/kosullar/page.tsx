  ...
  return (
    <main className="mx-auto max-w-2xl px-6 py-16">
      ...
      <div className="mt-8 space-y-6 text-sm leading-relaxed text-ink">
        <section><h2 className="mb-2 font-bold">1. Genel</h2><p>Yorum Tezgahı'nı kullanarak aşağıdaki şartları kabul etmiş sayılırsın.</p></section>
        <section><h2 className="mb-2 font-bold">2. Yorum ve içerik kuralları</h2><p>Yalnızca gerçek deneyimlerini paylaş. Sahte, yanıltıcı, hakaret içeren içerik paylaşmak yasaktır.</p></section>
        <section><h2 className="mb-2 font-bold">3. Hesap sorumluluğu</h2><p>Hesabınla yapılan tüm işlemlerden sen sorumlusun.</p></section>
        <section><h2 className="mb-2 font-bold">4. Sorumluluk reddi</h2><p>Sitedeki yorumlar kullanıcılar tarafından yazılır ve kişisel görüşlerini yansıtır.</p></section>
